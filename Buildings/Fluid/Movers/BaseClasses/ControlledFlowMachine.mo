...
equation
  ...
  etaHyd = cha.efficiency(per=per.hydraulicEfficiency, r_V=r_V, d=hydDer, r_N=1, r_N_small=0.1);
  etaMot = cha.efficiency(per=per.motorEfficiency,     r_V=r_V, d=motDer, r_N=1, r_N_small=0.1);
  dpMachine = -dp;
